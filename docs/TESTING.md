...
| Product folder discovery | `scripts/pipeline/product-folder-classifier.ts` | High |
...
```bash
npm run test         # 325 unit/integration tests (business, pipeline, doctor, data)
npm run build        # production static build (42 pages)
