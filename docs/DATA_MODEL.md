...
| Property | Type | Required | Example | Notes |
| --- | --- | --- | --- | --- |
| `id` | string | Yes | `BK-CA-001` | System-managed unique identifier. Generated by the pipeline when blank (format `{BA}-{Collection Code}-{NNN}`) and written back to the sheet; otherwise never modified. |
